...
map.getView().fit([-1039412.450488, 843284.622007, 895678.819577, 1834885.856864], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DISTRIBUTION DE LA POPULATION DU BF EN 2019</h2>';
        return titleElement;
    })(),
